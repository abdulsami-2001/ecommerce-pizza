            ...
            <nav className="py-5 px-5 flex justify-between">
                <div className='flex items-center space-x-4'>
                    ...
                    <Select>
                        ...
                        <SelectContent>
                            <SelectItem value="Pizza Max">Pizza Max</SelectItem>
                ...
                <div className='flex space-x-8'>
                    <div className='flex items-center space-x-4 '>
                        <ul className='flex items-center space-x-4 font-medium '>
                            ...
                            <li>
                                <Link className='hover:text-primary' href={'/orders'}>Orders</Link>
                            </li>
                        </ul>
                        <div className='relative'>
                            ...
                            <span className='absolute p-1 rounded-full -top-3 -right-2 bg-primary  h-6 w-6 flex justify-center items-center font-bold text-base text-background' >
                                10
                            </span>
                        </div>
                    </div>
